...
export default function NavItemDropdown() {
  ...
  return (
    <Menu as="div" className="relative inline-block  w-full h-auto min-h-10">
      ...
      >
        <Menu.Items className="absolute flex justify-center mb-3 lg:mb-0 right-0 lg:right-auto   rounded-none focus:outline-none z-50 w-full bg-[#D9D9D9] dark:bg-[#1B2B3C] py-34">
          <div className="grid rounded-none lg:w-full shadow-lg  dropdownContentBg p-3 gap-y-1.5">
            <Link
              href="/tester"
              className="flex h-8 items-center gap-1 justify-end w-full text-sm text-black dark:text-white px-[30px]"
            >
              دفع الرسوم المتفرقة
              <svg
                xmlns="http://www.w3.org/2000/svg"
